...
.. function:: PhysicalEffect.fire_point_source(tag, minf=0.055, k=1.5, Radiative_Fraction=1)
   ...
   This command is exactly same :ref:`fire_point_source <firepointsource>` Command and the only differece of them is the cosidering atmospheric transmissivity. Check equations (3.13) and (3.16) of Casal book [Ref.1]_.
   ...
   .. admonition:: Example:
      ...
      **Python Code**
      ...
      .. code-block:: python
        ...
        opr.PhysicalEffect.Simple_fire_point_source(1,minf=0.0501,k=1.5,Radiative_Fraction=0.4)
